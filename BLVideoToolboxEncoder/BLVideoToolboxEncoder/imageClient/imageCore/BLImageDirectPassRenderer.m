...
@implementation BLImageDirectPassRenderer{
...
- (BOOL)prepareRender{
    ...
    _program = [[BLImageProgram alloc] initWithVertexShaderString:directPassVertexShaderString
                                             fragmentShaderString:directPassFragmentShaderString];
    if (_program) {
...
- (void)renderWithTextureId:(int)inputTex
    ...
    glVertexAttribPointer(displayPositionAttribute,
                          2,
                          GL_FLOAT,
                          0,
                          0,
